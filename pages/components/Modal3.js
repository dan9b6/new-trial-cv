      ...
      <div className="container mt-5 pt-2 pb-4">
        ...
        <div className="row justify-content-center text-center align-items-center mb-4">
          <div className="col-md-6 px-5 py-3">
            ...
            <p>
              ...
              to watch GB take on South Korea. Unfortunately they lost 5-4 on
              penalties.
            </p>
          </div>
          <div className="col-md-6">
        ...
        <div className="row justify-content-center text-center align-items-center mb-4 reverse">
          <div className="col-md-6 px-5 py-3">
            ...
            <ul className="text-white ">
              ...
              <li>Next JS</li>
              <li>Bootstrap</li>
              <li>and many other skills which you can find on this link.</li>
            </ul>
            <p>
        ...
        <div className="row justify-content-center text-center align-items-center mb-4">
          <div className="col-md-6 px-5 py-3">
            <h2>2021</h2>
            <p>
              Now I am looking to start my career as a Web Developer. I don't
              have 100 years of experience, but I am 100% ready to start my
